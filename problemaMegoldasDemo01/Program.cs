internal class Program
{
    private static void Main(string[] args)
    {
        ...
        //int lefutasSzamlalo = 0;

        //while(lefutasSzamlalo != 2)
        //{
        //    ConsoleKeyInfo current = Console.ReadKey(true); //ReadKey felelős azért, hogy karaktereket olvassak be.
        //    //1 konkrét karakter beolvasásáért felelős, de mivel ciklust használunk, ezért amikor lefut a ciklus
        //    //mindig meg fog hívódni ez a karakter beolvasás és mindig el tudom tárolni a karaktert.
        //    //Jelen esetben a ConsoleKeyInfo csak azért felelős, hogy információkat tároljak a lenyomott 
        //    //billentyűről, nem magát a karaktert tárolom el, ehhez nekem meg kell majd hívni a current.Key-t, ami
        //    //vissza fogja adni a jelenlegi billentyűt, amit össze kell hasonlítsak majd a ConsoleKey.Enter-rel vagy
        //    //a ConsoleKey.Backspace-el. Magát a betűt meg a current.KeyChar-ral tudom letárolni.

        //    if (current.Key != ConsoleKey.Enter && current.Key != ConsoleKey.Backspace)
        //    {
        //        if (lefutasSzamlalo == 0)
        //        {
        //            jelszo += current.KeyChar;
        //        } else
        //        {
        //            jelszo2 += current.KeyChar;
        //        }
        //        Console.Write("*");
        //    }
        ...
        //    {
        //        if (lefutasSzamlalo == 0 && jelszo.Length > 0) //"jelszo.Length > 0" azért felelős, hogy ne 
        //            //próbáljunk meg a következő sorban olyan helyre mutatni a Substringgel, ami nem létezik, mert
        //            //egy szöveg annak a hossza minimum 0, nem lehet -1.
        //        {
        //            jelszo = jelszo.Substring(0, jelszo.Length - 1); //Ez felelős azért, ha törlök egy karaktert,
        //            //akkor az a háttérben a változóból is kitörölje a karaktert. Mert ez azt csinálja, hogy 
        //            //Substring(kezdőIndex, hányKarakter), megadod a kezdő indexet, azaz a 0 és azt hogy a 0-tól
        //            //számítva hány karaktert szeretnék megjeleníteni. Ha törlök 1 karaktert, akkor a "jelszo"
        //            //változómat szeretném felülírni egy olyan jelszóval, amiből az utolsó karakterem hiányzik.
        //            //Ekkor jön képbe a "jelszo.Length-1" ami az utolsó alőtti karaktert jelöli. Törlöm az utolsó
        //            //karaktert, akkor mondhatjuk, hogy az új utolsó karakterem az valójában a törlést követően
        //            //az utolsó előtti karakterem lesz.
        //        }
        //        else if (lefutasSzamlalo == 1 && jelszo2.Length > 0)
        //        {
        //            jelszo2 = jelszo2.Substring(0, jelszo2.Length - 1);
        //        }

        //        Console.Write("\b \b"); //ennek segítségével törlök a console-ról
        //        //működési elve pl.: kiírom, hogy "asd". Ebben az esetben a "\b \b" azt csinálja, hogy 
        //        //az első \b az visszalép a "d" karakterre, ez lesz kijelölve, "\b \b"-nél középen van egy " "
        //        //ezzel fogom felülírni a "d" karaktert, ekkor kapok egy ilyet: "as ", viszont még mindig a 
        //        //"d" karakterem van kijelölve (amit már helyettesítettem " " ezzel), ami nem jó, emiatt kell
        //        //ismét kiadnom a "\b"-t ami meg a " " mögé fogja léptetni a kurzort. Ez vizuálisan tünteti el a
        //        //karaktert.
        //    }

        //    else if (current.Key == ConsoleKey.Enter && !string.IsNullOrWhiteSpace(jelszo))
        //        //Nem engedjuk meg, hogy a "jelszo" egy üres karakter legyen, be kell valamit írni jelszónak.
        //        //Ezért felelős a string.IsNullOrWhiteSpace metódus.
        //    {
        //        Console.Clear(); //Ha leütöttük az entert és nem üres a stringünk, akkor töröljük a 
        //        //console tartalmát és kiírjuk az új információkat.
        //        Console.Write("Kérem adja meg a jelszót ismét: ");
        //        lefutasSzamlalo++;
        //    }

        //    if (lefutasSzamlalo == 2)
        //    {
        //        Console.Clear();
        //        if (jelszo == jelszo2) 
        //        {
