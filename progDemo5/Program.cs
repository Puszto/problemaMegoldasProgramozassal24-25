...
//    {
//        Console.Write($"On {DateTime.Now.Year}. {DateTime.Now.Month}. {DateTime.Now.Day}. numbers were: ");
//        string kiirat = $"On {DateTime.Now.Year}. {DateTime.Now.Month}. {DateTime.Now.Day}. numbers were: ";
...
//string[] bemenet = File.ReadAllLines("NHANES_1999-2018.csv");
////1
